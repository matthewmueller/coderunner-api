...
Vagrant.configure("2") do |config|
  ...
  if Dir.glob("#{File.dirname(__FILE__)}/.vagrant/machines/default/*/id").empty?
    ...
    pkg_cmd << "apt-get install -y make python g++;" \
      ...
      "curl http://nodejs.org/dist/v0.11.7/node-v0.11.7-linux-x64.tar.gz | tar -C /usr/local/ --strip-components=1 -zxv;"
    ...
    # pkg_cmd << "sudo -u vagrant git clone https://github.com/MatthewMueller/coderunner-api.git /home/vagrant/coderunner-api;" \
    #   "cd /home/vagrant/coderunner-api; make images;" \
    #   "sudo -u vagrant cd /home/vagrant/coderunner-api; make;"

    # Update the docker socket
    # pkg_cmd << "chown vagrant /var/run/docker.sock"
